...
public class LoginStepDefinitions {
    ...
    public void ingresa_el_usuario_y_la_contrasena(
            String usuario,
            String clave) {
    ...
    public void deberia_ver_el_saludo(String saludo) {
        ...
        theActorInTheSpotlight().attemptsTo(
                that(TextoDe.el(DashboardScreen.SALUDO))
                        .isEqualTo(saludo)
        );
    }
    ...
    public void el_saldo_mostrado_deberia_ser(String saldo) {
        ...
        theActorInTheSpotlight().attemptsTo(
                that(TextoDe.el(DashboardScreen.SALDO_PRINCIPAL))
                        .isEqualTo(saldo)
        );
    }
    ...
    public void deberia_ver_el_mensaje_de_error(String mensaje) {
        ...
        theActorInTheSpotlight().attemptsTo(
                that(TextoDe.el(LoginScreen.ERROR_LOGIN))
                        .isEqualTo(mensaje)
        );
    }
}
