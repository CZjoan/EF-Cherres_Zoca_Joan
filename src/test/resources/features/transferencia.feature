...
Característica: Transferencia a beneficiarios
  ...
  Escenario: Usuario sin saldo no puede realizar una transferencia
    Dado que inicia sesión con el usuario "sinsaldo"
    Cuando intenta transferir 100.00 al beneficiario "Maria Torres"
